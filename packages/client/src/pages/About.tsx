    ...
    <div className="max-w-4xl mx-auto space-y-12">
      ...
      <section className="bg-white shadow rounded-lg p-8">
        ...
        <div className="prose prose-gray max-w-none">
          ...
          <p className="text-gray-600 leading-relaxed mt-4">
            Swarm Vault provides first class support for programmatic trading with the API.  You can easily build your own trading bot or hook up an LLM to execute trades.
          </p>
        </div>
      </section>
